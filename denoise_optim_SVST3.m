...
% parfor supported
%----------------------------------------------------
function  [im_out, rank_out] =denoise_optim_SVST3(nim,b,step,Sig)
% to denoise using the optimal singular value soft thresholding.
...
optsoft = @(x)( max(0, x-(1+sqrt(M/N)))); % optimal soft threshold
