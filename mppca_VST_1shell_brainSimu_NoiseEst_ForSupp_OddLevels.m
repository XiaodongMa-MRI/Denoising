...
%
save -v7.3 sigEst_fastvarying_fullFOV_new_OddLevels Sigma_VST_A Sigma_VST_B ...
    Sigma_MPPCA Sigma0 Sigma1 levels sm mask IM_R dwi00

%%
load sigEst_fastvarying_fullFOV_new_OddLevels Sigma_VST_A Sigma_VST_B Sigma_MPPCA ...
...
%% VST A vs VST B for VST
 load sigEst_fastvarying_fullFOV_new_OddLevels Sigma_VST_B mask IM_R dwi00 levels
...
switch myconfig
    case 1
        VST_ABC='A';
        fn= 'IMVSTd_AvsB_A_OddLevels';
    case 2
        VST_ABC='B';
        fn= 'IMVSTd_AvsB_B_OddLevels';
    otherwise
end
...
%%
PSNR_A= load('IMVSTd_AvsB_A_OddLevels.mat','PSNR')
PSNR_B= load('IMVSTd_AvsB_B_OddLevels.mat','PSNR')
...
%%
sig_A= load('IMVSTd_AvsB_A_OddLevels.mat','Sigma_MPPCA')
sig_B= load('IMVSTd_AvsB_B_OddLevels.mat','Sigma_MPPCA')
soi=8;
