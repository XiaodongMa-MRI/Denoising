...
IM_R = single(IM_R);
if bRacianNoise
    save -v7.3 data_2shell_brain_noisy_10AvgRacian dwi dwi00 sm mask nz ksize IM_R Sigma0 Sigma1 levels bvals
else
    save -v7.3 data_2shell_brain_noisy_10AvgGaussian dwi dwi00 sm mask nz ksize IM_R Sigma0 Sigma1 levels bvals
end
