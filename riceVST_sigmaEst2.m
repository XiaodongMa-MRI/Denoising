function sigma_hat = riceVST_sigmaEst2(z,printOut,est_type,VST_ABC,sigma_hat,maxIter,r_tolerance)
% Robust estimatation of noise level from Rician-distributed data
% --------------------------------------------------------------------------------------------
%
% this is a slightly tuned version of the original riceVST_sigmaEst.m
% 
% SYNTAX
% ------
% sigma_hat = riceVST_sigmaEst ( z , printOut , est_type , VST_ABC , sigma_hat,maxIter , r_tolerance )
%
%
% OUTPUT
% ------
