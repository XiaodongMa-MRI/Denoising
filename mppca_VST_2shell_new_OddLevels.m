...
switch myconfig
    case 1
        ...
        fn1= 'IMVST_2shell_OddLevels.mat'; %
        %fn= 'denoiseVST_nonstationaryNoise_fullfov_multishell_ws5_new';
        fn2= 'IMVSTd_2shell_OddLevels.mat';
        fn3='IMVSTd_EUIVST_2shell_OddLevels.mat';
        fn_mppca='IMd_mppca_2shell_OddLevels.mat';
        fn_psnr='psnr_2shell_OddLevels.mat';
%     case 2
